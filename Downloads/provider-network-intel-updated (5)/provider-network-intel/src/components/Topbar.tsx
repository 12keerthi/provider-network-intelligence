...
export default function Topbar() {
  ...
  return (
    <header className="flex h-16 shrink-0 items-center gap-3 border-b border-navy-800 bg-navy-900 px-4 lg:px-6">
      ...
      <div className="relative hidden shrink-0 items-center gap-2 rounded-lg border border-navy-800 bg-navy-950/40 px-3 py-2 text-sm text-slate-400 lg:flex">
        <Search className="h-4 w-4" />
        <input
          type="text"
          placeholder="Search areas, providers..."
