  ...
  return (
    <AuthLayout title="Please sign in to your account">
      <form onSubmit={handleSubmit} noValidate className="space-y-4">
        ...
        {forgotNotice && (
          <p className="rounded-lg border border-white/10 bg-navy-950/60 px-3 py-2.5 text-xs text-slate-400">
            Password reset isn't available yet — this demo stores accounts locally in your browser only.
          </p>
        )}
